...
const CHALLENGES: Record<number, Record<number, ChallengeInput[]>> = {
  ...
  1: {
    ...
    3: [
      {
        audioUrl: A(1, 3, 1),
        audioScript: "Dagat pressed deeper into Isla ng Salita — past the first dock, past the market stalls, into the quieter middle of the village where Ingay's spell felt thicker. A fisherman stood frozen at the center of the market square, one hand raised mid-gesture, his face set in the expression of someone who had finally made up his mind about something he had resisted for a long time. The story seeped through the interference slowly, like water through cracked timber. Old Isko had not wanted to lend his boat. Everyone in the village knew it. He had crossed his arms and said 'no' twice, and the second time he said it he turned his back on them entirely. But the storm was coming and the crew had no other vessel, and in the end, old Isko's feet walked him back to the dock before his mind had made up its decision. He threw the rope to them without a word. He sat on the dock wall and watched them sail out. When they returned safely, someone asked him why he changed his mind. He didn't answer. He just coiled the rope. Dagat watched his frozen face and understood the word before she found it.",
        question: "What does 'reluctant' most likely mean as used in the passage?",
        choices: [
          { label: "A", text: "Eager and enthusiastic to help from the start" },
          { label: "B", text: "Unwilling at first but eventually doing something anyway" },
          { label: "C", text: "Angrily refusing to cooperate with anyone" },
          { label: "D", text: "Too confused to make a decision" },
        ],
        answer: "B",
        explanation: "Old Isko said no twice and turned his back — but in the end his feet walked him back to the dock. That pattern of unwillingness followed by action is exactly what 'reluctant' means.",
        hint: "Did Isko want to help? What did he do despite not wanting to? Those two things together describe the word.",
      },
      {
        audioUrl: A(1, 3, 2),
        audioScript: "Another frozen figure at the edge of the market square — a very young sailor, too new to have calluses yet, caught mid-sentence in some kind of quiet plea to an older officer. The words came through jagged but the picture they painted was clear. Twelve-year-old Tomas had asked the boatswain every morning for two months if he could practice the helm. The boatswain always said 'not yet.' Tomas began arriving an hour before every drill, ropes already coiled, station already set. He stayed after each session to re-clean what had already been cleaned. He wrote the sixteen knots on paper and taped them to the inside of his sea bag and read them before every watch. He never complained. He just tried, quietly and completely, every single day. On the forty-third morning, the boatswain handed him the wheel without a word. Dagat held that picture in her mind — the forty-three mornings — and the word came with it.",
        question: "What does 'earnest' most likely mean as used in this passage?",
        choices: [
          { label: "A", text: "Naturally talented and skilled without much effort" },
          { label: "B", text: "Quietly hoping someone else will step in to help" },
          { label: "C", text: "Showing deep, sincere effort and dedication" },
          { label: "D", text: "Impatient and eager to skip ahead" },
        ],
        answer: "C",
        explanation: "Tomas arrived early, stayed late, studied on his own — every day for forty-three days without being asked. That genuine, wholehearted effort is what 'earnest' means.",
        hint: "What word describes someone who tries as hard as Tomas did, every day, sincerely and without complaint?",
      },
    ],
    4: [
      {
  ...
  2: {
    ...
    3: [
      {
        audioUrl: A(2, 3, 1),
        audioScript: "Dagat pressed further into the Bilis harbor district, the time-blur now constant — every announcement a blur of sound that she had to slow in her own mind to catch. A fleet assignment officer's voice crackled from a message post ahead, the words overlapping themselves at Ingay's unnatural pace. Attention all crew of the Balisang and the Salabid! Change to pier assignments effective immediately. The Balisang — previously assigned to Pier Four, north side — is now reassigned to Pier Six, south side. Berth space at Pier Four has been taken by an emergency resupply vessel. The Salabid remains at Pier Three as originally posted. All cargo handlers and rigging crew should adjust their positions accordingly. Dock supervisor Mana confirms the change. Fair winds and steady moorings! She caught the number before it vanished.",
        question: "Where is the Balisang now assigned to dock?",
        choices: [
          { label: "A", text: "Pier Three, north side" },
          { label: "B", text: "Pier Four, south side" },
          { label: "C", text: "Pier Six, south side" },
          { label: "D", text: "Pier Five, north side" },
        ],
        answer: "C",
        explanation: "The announcement said the Balisang was 'now reassigned to Pier Six, south side.' Pier Four was taken by another vessel. The new assignment is Pier Six, south side.",
        hint: "Listen for the word 'now' — the pier stated immediately after it is the new assignment.",
      },
      {
        audioUrl: A(2, 3, 2),
        audioScript: "A medical supply courier on Isla ng Bilis was reciting an inventory update, speaking at the pace Ingay forced on everything — syllables colliding, pauses removed. Dagat planted her feet and listened for the specific item that mattered. Port Alingawngaw medical depot update! Effective this morning: fresh bandage wraps are now restocked — full supply available. Fever tonic remains out of stock and is not expected until next port call. Surgical thread is available in limited quantities — officers only. Drinking salts are fully restocked. The splint boards ordered three weeks ago have arrived and are available at Counter Two. Report any urgent medical needs to the duty nurse at the Red Anchor station immediately. She had exactly one item on the list to hold: the one still missing.",
        question: "Which medical supply is still out of stock?",
        choices: [
          { label: "A", text: "Bandage wraps" },
          { label: "B", text: "Surgical thread" },
          { label: "C", text: "Fever tonic" },
          { label: "D", text: "Drinking salts" },
        ],
        answer: "C",
        explanation: "'Fever tonic remains out of stock.' All other items mentioned were either restocked or available in some quantity. 'Remains' signals it has not changed.",
        hint: "Listen for the phrase 'remains out of stock' — which item follows those words?",
      },
    ],
    4: [
      {
  ...
  3: {
    ...
    3: [
      {
        audioUrl: A(3, 3, 1),
        audioScript: "Still in the fog of Isla ng Diwa — thicker now at Pin 3, pressing in from all sides. A voice rose from somewhere to Dagat's left, unhurried and tired, full of complaints she had to push past to find what the speaker really wanted. A dock officer, it sounded like, addressing a restless crew. The morning gale delayed us by six hours. The supply barge from the northern islands still hasn't arrived. Three of our best riggers are down with sea fever. The charts we requested from Port Salita haven't been corrected yet. I know you're frustrated. I know the dock is crowded and the timeline has slipped. But I need you all to do one thing: wait. Hold your stations. Let the situation resolve itself. These things always do. The fog always lifts. The barge always comes. Our job right now is to stay steady and trust the process. Dagat found it — underneath every complaint, just one thing the officer wanted from the crew.",
        question: "What is the main point of the officer's speech?",
        choices: [
          { label: "A", text: "To explain why the supply barge is running late" },
          { label: "B", text: "To report the full list of problems they are facing" },
          { label: "C", text: "To urge the crew to stay patient through difficult delays" },
          { label: "D", text: "To announce that three riggers are too sick to work" },
        ],
        answer: "C",
        explanation: "The officer lists delays but keeps returning to one message: wait, hold steady, trust the process. The complaints are background details. Patience is the point.",
        hint: "What does the officer keep asking the crew to do? That repeated instruction is the main point.",
      },
      {
        audioUrl: A(3, 3, 2),
        audioScript: "Deeper into the fog, a captain's voice reached Dagat — measured and deliberate, listing many things but clearly building toward one. Dagat breathed slowly and followed the thread from detail to detail until she found where it led. We have checked every hatch and sealed the ones showing wear. The bilge pumps have been tested — all working. Each sailor has been assigned their storm station. The safety ropes have been doubled along the main deck. The cook has prepared cold provisions in sealed tins in case the galley fire must be put out. We have done what we can with the time we have. There is only one thing that matters now: every decision we make from this point forward must put the safety of this crew first. Nothing else. No schedule, no cargo, no reputation — only the crew. Dagat followed it from beginning to end and saw exactly where it landed.",
        question: "What is the main message of the captain's speech?",
        choices: [
          { label: "A", text: "To give a detailed checklist of all the storm preparations" },
          { label: "B", text: "To warn the crew that the galley fire might go out" },
          { label: "C", text: "To emphasize that the crew's safety is the top priority" },
          { label: "D", text: "To explain that schedules and cargo still matter" },
        ],
        answer: "C",
        explanation: "The captain lists preparations, but the speech ends with one point: everything must put 'the safety of this crew first.' Every detail serves that conclusion.",
        hint: "What is the very last thing the captain says? The final statement usually carries the main message.",
      },
    ],
    4: [
      {
  ...
  4: {
    ...
    3: [
      {
        audioUrl: A(4, 3, 1),
        audioScript: "A sailor's report on Isla ng Damdamin — flat as everything else here, every trace of emotion stripped by Ingay's drain. But Dagat had learned to read the shape of words even without their feeling. This one described a hard moment at the dock. I tried to bring the Baybayin in at the south berth during the squall. The wind shifted twice while I was on approach. The first attempt, I had to abort when the swell pushed us sideways. Second attempt, we got within twenty meters and lost the line. I radioed the harbormaster to let him know we'd try again at first light. Got some rest. Went back. Third attempt worked. We were six hours behind schedule. But we docked. Dagat found the tone beneath the flat report — not complaint, not sorrow, not defeat. Something quieter and harder than any of those.",
        question: "What is the overall tone of the speaker's report?",
        choices: [
          { label: "A", text: "Defeated and bitter about the failed attempts" },
          { label: "B", text: "Calm and determined despite multiple setbacks" },
          { label: "C", text: "Frustrated and angry at the harbormaster" },
          { label: "D", text: "Confused about why the attempts failed" },
        ],
        answer: "B",
        explanation: "No blame, no self-pity — just 'tried again, worked.' The speaker reports difficulty factually and moves directly to the outcome. That is calm determination.",
        hint: "How does the speaker respond to each failed attempt? Their reaction to failure reveals their tone.",
      },
      {
        audioUrl: A(4, 3, 2),
        audioScript: "A veteran navigator was giving directions to a young sailor on Isla ng Damdamin — her voice completely stripped of warmth by Ingay's drain, arriving as flat instruction, technical and dry. Dagat stood nearby and listened for what was hidden underneath. The current here pulls northeast at six knots when the tide shifts. You'll feel it in the wheel before you see it in the water. Correct early — don't wait until the bow is already moving. When you start feeling that pull, put in the adjustment now. Most sailors your age overcorrect and end up worse than they started. You don't do that. You've got a quiet hand. I've seen it. That is going to serve you a very long time at sea. The words were mostly technical — but one thing was not technical at all. Dagat heard what the flatness was trying to hide.",
        question: "Which phrase reveals that the navigator has a positive view of the young sailor?",
        choices: [
          { label: "A", text: "\"The current here pulls northeast at six knots\"" },
          { label: "B", text: "\"You'll feel it in the wheel before you see it in the water\"" },
          { label: "C", text: "\"You've got a quiet hand. I've seen it.\"" },
          { label: "D", text: "\"Most sailors your age overcorrect\"" },
        ],
        answer: "C",
        explanation: "'You've got a quiet hand. I've seen it.' is personal observation and quiet praise. The rest is technical instruction about currents. Only that phrase reveals genuine positive regard.",
        hint: "Which line is about the sailor as a person, not about a sailing technique? That line holds the feeling.",
      },
    ],
    4: [
      {
  ...
  5: {
    ...
    3: [
      {
        audioUrl: A(5, 3, 1),
        audioScript: "Four shards gleamed in Dagat's satchel as she pushed deeper into Isla ng Tanong — Ingay's scatter at its most relentless here, facts darting away mid-sentence. A port supply captain's voice cut through the noise with an update, and Dagat caught it with everything she had. Attention fleet crew — supply update for the week's long sail. We are leaving port with forty-two barrels of fresh water. That sounds like a lot. With a full crew of thirty-eight sailors drinking and cooking, we will have enough for exactly fourteen days at normal rations. Our scheduled resupply stop is at the Coral Station waypoint on the tenth day. I want every quartermaster to confirm their section's daily water log by this evening. If anything seems off, report it to me before we cast off. Fair winds and tight barrels. Dagat locked the two numbers that mattered most.",
        question: "How many barrels of fresh water are they leaving port with?",
        choices: [
          { label: "A", text: "Thirty-eight" },
          { label: "B", text: "Ten" },
          { label: "C", text: "Fourteen" },
          { label: "D", text: "Forty-two" },
        ],
        answer: "D",
        explanation: "'We are leaving port with forty-two barrels.' Thirty-eight is the crew count, fourteen is how long the water lasts, and ten is the resupply day — all different numbers with different meanings.",
        hint: "Listen for the number that comes right after the words 'leaving port with.' That is the barrel count.",
      },
      {
        audioUrl: A(5, 3, 2),
        audioScript: "A maritime training announcement crackled through Isla ng Tanong — Ingay's scatter working hardest on the specific details, the facts darting away before Dagat could anchor them. She stopped, steadied herself, and caught the announcement as it reached a key correction. Attention all junior crew! The anchor-handling drill scheduled for this afternoon will be held at Dock Fourteen — not Dock Eleven as originally posted. Please note: the drill begins at two bells past noon, not at noon itself. Participants must bring their standard rigging harness and identification tag. Any junior crew member who arrives after the first exercise without a valid excuse will be required to repeat the full drill the following week. Questions should be directed to Watch Officer Reyes, stationed at the dock gate. Fair winds! She marked the two corrections before they could scatter.",
        question: "What time does the anchor-handling drill begin?",
        choices: [
          { label: "A", text: "At noon exactly" },
          { label: "B", text: "Two bells past midnight" },
          { label: "C", text: "Two bells past noon" },
          { label: "D", text: "At Dock Eleven" },
        ],
        answer: "C",
        explanation: "The announcement corrected itself: 'two bells past noon, not at noon itself.' The word 'not' signals the wrong time — the right time follows the correction.",
        hint: "Listen for the word 'not' — it signals a correction. The new time comes right after it.",
      },
    ],
    4: [
      {
  ...
  6: {
    ...
    3: [
      {
        audioUrl: A(6, 3, 1),
        audioScript: "Five shards, and the storytellers of Isla ng Kwento were still frozen mid-memory. Dagat found a folktale fragment — the middle clear, the edges in pieces — and worked with what she had. A weaver needed to cross the river to reach the market. She tried first by following the stepping stones. The water was high and her basket tipped — she had to turn back. She tried again with a bamboo pole as a balance rod. She made it three steps before the current shifted and she lost her footing. She stood on the bank a long while. Then she looked upriver, not across it, and found a place where a fallen tree had created a natural bridge. She crossed there — dry, basket balanced, one hand free. She never used the stepping stones again. Dagat followed the three attempts and held the third until the answer was clear.",
        question: "What finally allowed the weaver to cross the river?",
        choices: [
          { label: "A", text: "Using a bamboo pole as a balance rod" },
          { label: "B", text: "Waiting for the water level to drop" },
          { label: "C", text: "Being more careful with the stepping stones" },
          { label: "D", text: "Finding a fallen tree that formed a natural bridge" },
        ],
        answer: "D",
        explanation: "The first attempt failed (stepping stones), the second failed (bamboo pole), and the third worked — she found a fallen tree forming a natural bridge. That was the solution.",
        hint: "Three attempts: first fails, second fails, third works. What did the weaver use in the third attempt?",
      },
      {
        audioUrl: A(6, 3, 2),
        audioScript: "Another broken memory on Isla ng Kwento — a sailor's account, the edges in fragments but the central decision intact. Dagat pieced together what she could. He had sailed under three captains and trusted all of them. The third one left the crew behind during a storm. After that, he stopped trusting easily. He took smaller ships with smaller crews. He learned to read weather himself instead of relying on officers. He started keeping his own logbook — every port, every current, every decision. Ten years later, someone asked him why he kept such detailed records. He said it was because the day he stopped trusting completely was the day he started paying attention completely. What he lost on one side, he decided to build on the other. Dagat found the decision in the center of the broken memory.",
        question: "What did the sailor decide to do after losing trust in captains?",
        choices: [
          { label: "A", text: "Leave the sea entirely and find work on land" },
          { label: "B", text: "Try to find the third captain and confront him" },
          { label: "C", text: "Build his own skills and keep detailed records himself" },
          { label: "D", text: "Report the abandonment to the fleet authority" },
        ],
        answer: "C",
        explanation: "After the betrayal, the sailor stopped relying on officers and started learning everything himself — reading weather, keeping his own logbook. He built what he'd lost.",
        hint: "What two things did the sailor start doing on his own after that? Those actions describe his decision.",
      },
    ],
    4: [
      {
  ...
  7: {
    ...
    3: [
      {
        audioUrl: A(7, 3, 1),
        audioScript: "Six shards glowing, and the chaos of Isla ng Alingawngaw pressed on Dagat from every side — vocabulary scrambled, speed accelerating, fog pressing in, emotion draining, facts scattering, stories fracturing — all at once, Ingay's full arsenal. A voice cut through it all: a fleet surgeon delivering an urgent medical report, her tone deliberately calm against the chaos, every word chosen with precision. This is Surgeon Mana. We have treated fourteen sailors in the last six hours. None are critical. The injuries are minor — rope burns, sprains, one case of sea fever caught early. The crew's response time was exceptional. Not one injury worsened because help was delayed. What I want the crew to understand is this: the speed with which you helped each other today was not ordinary. It was admirable. That word — admirable — means you acted with a quality worth praising. Remember it. You will need it again before this island is done. Dagat caught three things at once: the word, the count, and the calm courage beneath the surgeon's voice.",
        question: "What does 'admirable' mean as used by the surgeon?",
        choices: [
          { label: "A", text: "Surprising and completely unexpected" },
          { label: "B", text: "Careful and technically correct only" },
          { label: "C", text: "Worth praising; genuinely impressive" },
          { label: "D", text: "Fast and efficient but ordinary" },
        ],
        answer: "C",
        explanation: "The surgeon defines the word directly: 'a quality worth praising.' The context — no injuries worsened because the crew responded so well — confirms it means genuinely impressive.",
        hint: "The surgeon gives the definition as she uses the word. Listen for the explanation that follows it.",
      },
      {
        audioUrl: A(7, 3, 2),
        audioScript: "A story reached Dagat through the noise of Isla ng Alingawngaw — broken at its edges but clear at its center. It was told by a voice she didn't recognize, but one that carried the weight of someone who had been at sea a very long time. She followed the fragments from the first one she could catch. I don't remember the name of every port I've docked at. I don't remember the names of every sailor I've crewed with. But I remember the ones who listened. The ones who sat still while another sailor talked. The ones who asked a second question when they could have asked none. The ones who said 'tell me more' instead of 'I understand already.' Every good decision I've made at sea came from listening — not to charts, not to stars, but to the person beside me on the watch. If there's one thing I want you to carry off this island, it is that: listen to the person beside you. That is the whole of it. Dagat felt the words settle in her like a compass finding north.",
        question: "What is the main message of the speaker?",
        choices: [
          { label: "A", text: "The importance of remembering names and port locations" },
          { label: "B", text: "How to make good decisions using charts and stars" },
          { label: "C", text: "That listening to the people around you is the most important skill" },
          { label: "D", text: "That experienced sailors always learn faster than inexperienced ones" },
        ],
        answer: "C",
        explanation: "The speaker's final statement says it plainly: 'listen to the person beside you. That is the whole of it.' Everything before that builds to this one point.",
        hint: "What does the speaker say at the very end? The last line is the message they most want the listener to carry.",
      },
    ],
    4: [
      {
...
const islandDefs = [
  {
    ...
    ingayDialogue: "Frozen in silence, are they? Good. Words without meaning are my favourite kind of noise. Let's see if you can thaw them.",
  ...
  },
  {
    ...
    ingayDialogue: "Too fast for you? I made time itself my ally. Every word will blur before it reaches your ears. Enjoy the rush.",
  ...
  },
  {
    ...
    ingayDialogue: "I wrapped this island in fog so thick, not even the main idea can breathe. Find it — if you can see through me.",
  ...
  },
  {
    ...
    ingayDialogue: "I drained every feeling from their voices. Flat. Colourless. Emotionless. Let's see you find the heart in nothing.",
  ...
  },
  {
    ...
    ingayDialogue: "Names. Dates. Numbers. I scattered every last one. You'll reach for a fact and find only static.",
  ...
  },
  {
    ...
    ingayDialogue: "I shattered their memories mid-story. No beginning. No end. Just broken pieces — and you, trying to make sense of them.",
  ...
  },
  {
    ...
    ingayDialogue: "This is my stronghold, little sailor. Every trick I know — all at once. You will not leave here whole.",
...
async function main() {
  ...
  for (const def of islandDefs) {
    const island = await prisma.island.upsert({
      ...
      update: {
        ...
        ingayDialogue: def.ingayDialogue,
  ...
  // ── Multiplayer challenges (separate pool, no pin association) ──────────────
  await prisma.multiplayerChallenge.deleteMany();
  await prisma.multiplayerChallenge.createMany({
    data: MULTIPLAYER_CHALLENGES.map((c, i) => ({
      audioUrl: c.audioUrl,
      audioScript: c.audioScript,
      question: c.question,
      choices: c.choices as any,
  ...
  console.log(`✓ Multiplayer challenges: ${MULTIPLAYER_CHALLENGES.length} seeded`);
...
// ─── Multiplayer-Only Challenge Pool ─────────────────────────────────────────
// 35 ship/crew themed listening comprehension challenges.
// Completely independent from single-player islands/pins.

const MULTIPLAYER_CHALLENGES: ChallengeInput[] = [
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q1.mp3",
    audioScript: "Good morning, crew. I am Captain Mendez, and before we set sail I have three announcements. First, the main sail was repaired overnight — it is now fully operational. Second, our water barrels were refilled at the last port, so we have enough supply for twelve days. Third, the cook has reported that we are running low on salt fish. We will need to restock at the next harbor, which is approximately three days away. Any questions must be directed to the first mate. We depart at the second bell.",
    question: "What supply does the cook report is running low?",
    choices: [
      { label: "A", text: "Fresh water" },
      { label: "B", text: "Salt fish" },
      { label: "C", text: "The main sail" },
      { label: "D", text: "Water barrels" },
    ],
    answer: "B",
    explanation: "Captain Mendez says 'the cook has reported that we are running low on salt fish.' The main sail was repaired, and the water barrels were recently refilled.",
    hint: "Listen for what the cook specifically reported.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q2.mp3",
    audioScript: "Attention! I am the dock inspector for this port. Every vessel departing today must have three things checked: hull integrity, anchor chain length, and cargo weight. Hull integrity — the ship must have no visible cracks below the waterline. Anchor chain — must be at least twenty meters long. Cargo weight — must not exceed the vessel's marked load limit. Any ship that fails one check is held for repair. Any ship that fails two or more checks is impounded. Today I inspected fourteen vessels. Twelve passed all three. One failed the anchor chain check. One was impounded.",
    question: "How many ships were impounded today?",
    choices: [
      { label: "A", text: "Zero" },
      { label: "B", text: "One" },
      { label: "C", text: "Two" },
    ...
    answer: "B",
    explanation: "The inspector says 'one was impounded' — the ship that failed two or more checks. One failed only the anchor chain check and was held for repair, not impounded.",
    hint: "Listen for the rule about failing two checks, then for how many ships that applied to.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q3.mp3",
    audioScript: "Listen carefully. I am the ship's navigator, and what I tell you now could save our lives. We are approaching the Straits of Kalayan. The straits are safe during high tide — the water is deep enough and the currents are manageable. During low tide, however, the rocks beneath the surface become dangerous. The southern passage through the straits is always safe at any tide. The northern passage is only safe during high tide. The tide turns in approximately two hours. We are currently at high tide. My recommendation: take the northern passage now, before the tide changes.",
    question: "When is the northern passage through the straits safe?",
    choices: [
      { label: "A", text: "Only during low tide" },
      { label: "B", text: "At any time" },
      { label: "C", text: "Only during high tide" },
      { label: "D", text: "Never — it is always dangerous" },
    ],
    answer: "C",
    explanation: "The navigator says the northern passage 'is only safe during high tide.' The southern passage is always safe at any tide.",
    hint: "The navigator compares two passages — listen for the specific condition for the northern one.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q4.mp3",
    audioScript: "I have been the cook on this ship for nine years. People think cooking at sea is the same as cooking on land. It is not. The biggest problem is fire — you must never leave the stove unattended because a fire at sea can sink the ship faster than any storm. The second problem is fresh ingredients. After three days at sea, everything fresh is gone, and we rely on salted and dried foods. I solve this by keeping a small box of soil and growing herbs on the windowsill. It sounds small, but a little fresh herb changes everything.",
    question: "What does the cook consider the biggest problem of cooking at sea?",
    choices: [
      { label: "A", text: "The lack of fresh ingredients" },
      { label: "B", text: "The difficulty of keeping the stove lit" },
      { label: "C", text: "The risk of fire sinking the ship" },
      { label: "D", text: "The smell of salted food" },
    ],
    answer: "C",
    explanation: "The cook says 'the biggest problem is fire — a fire at sea can sink the ship faster than any storm.'",
    hint: "The cook names problems in order — listen for the one called 'the biggest.'",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q5.mp3",
    audioScript: "This is the lifeboat drill announcement. When you hear three short horn blasts, stop whatever you are doing and proceed immediately to your assigned muster station. Do not return to your cabin for belongings. Do not use the main staircase — use the emergency ladders only. At your muster station, put on your life vest before doing anything else. The first mate will count all crew and passengers. If someone is missing, report it to the first mate immediately. Do not get into the lifeboat until the order is given. This is a drill only. Three short blasts — remember.",
    question: "What should crew members do BEFORE getting into the lifeboat?",
    choices: [
      { label: "A", text: "Return to their cabin for belongings" },
      { label: "B", text: "Use the main staircase" },
      { label: "C", text: "Count all passengers" },
      { label: "D", text: "Put on their life vest" },
    ],
    answer: "D",
    explanation: "The instructions say 'put on your life vest before doing anything else' at the muster station.",
    hint: "Listen for the specific action at the muster station that must happen before the lifeboat.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q6.mp3",
    audioScript: "I am a traveling merchant and I need your help to understand a trade agreement. A buyer offered to purchase all my silk at fifteen gold per roll, but only if I deliver within five days. Another buyer offered twelve gold per roll with no deadline. I have eighty rolls of silk. The first deal gives me more gold total, but the five-day deadline is risky — the weather looks uncertain. The second deal is safer but earns me less. I chose the second buyer. My first mate says I made the wrong choice. What do you think?",
    question: "Why did the merchant choose the second buyer despite the lower price?",
    choices: [
      { label: "A", text: "The second buyer paid in advance" },
      { label: "B", text: "The weather made the five-day deadline risky" },
      { label: "C", text: "The first buyer wanted fewer rolls" },
      { label: "D", text: "The merchant preferred the lower price" },
    ],
    answer: "B",
    explanation: "The merchant says the five-day deadline was risky because 'the weather looks uncertain' — safety was the deciding factor.",
    hint: "The merchant explains the reason for the choice — listen for what made the first deal risky.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q7.mp3",
    audioScript: "I have sailed for forty years and I have three rules that have kept me alive. Rule one: always know where the nearest land is, even if you cannot see it. Rule two: never argue with the wind — if it changes, change with it. Rule three: the sea does not forgive arrogance. I have seen captains who ignored these rules. Some got lucky. Most did not. The sea is powerful and patient. It will wait for the moment you become careless. I have one scar on my left hand from the one time I broke Rule Two. I have never broken it again.",
    question: "What happened when the old sailor broke Rule Two?",
    choices: [
      { label: "A", text: "He was stranded on an island" },
      { label: "B", text: "He got a scar on his left hand" },
      { label: "C", text: "His ship sank" },
      { label: "D", text: "He lost his cargo" },
    ],
    answer: "B",
    explanation: "The sailor says 'I have one scar on my left hand from the one time I broke Rule Two.'",
    hint: "The sailor mentions a personal consequence — listen for the physical mark it left.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q8.mp3",
    audioScript: "Good afternoon. The harbor schedule for today is as follows. From first bell to third bell: incoming vessels only, no departures. From third bell to fifth bell: both arrivals and departures permitted. After fifth bell: departures only, no new arrivals accepted. Emergency vessels may enter at any time with radio clearance. Current time is halfway between second and third bell. Three vessels are waiting to depart. They must wait approximately thirty minutes more before they are permitted to leave.",
    question: "When are both arrivals AND departures permitted?",
    choices: [
      { label: "A", text: "From first bell to third bell" },
      { label: "B", text: "After fifth bell" },
      { label: "C", text: "From third bell to fifth bell" },
      { label: "D", text: "At any time with clearance" },
    ],
    answer: "C",
    explanation: "The schedule says 'from third bell to fifth bell: both arrivals and departures permitted.'",
    hint: "Three time windows are described — listen for which one allows both directions.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q9.mp3",
    audioScript: "I am the ship's doctor, and I want all crew to know the signs of scurvy. Scurvy is caused by a lack of vitamin C — it happens when sailors go too long without fresh fruit or vegetables. Early signs include tiredness and sore gums. If untreated, the gums begin to bleed and wounds stop healing. In severe cases, old healed wounds can reopen. The cure is simple: citrus fruit. We carry lime juice on this ship for exactly this reason. One cup per day per sailor is required during voyages longer than three weeks. No exceptions.",
    question: "What is the cure for scurvy according to the doctor?",
    choices: [
      { label: "A", text: "Rest and reduced activity" },
      { label: "B", text: "Citrus fruit" },
      { label: "C", text: "Extra salt in the diet" },
      { label: "D", text: "Wound bandaging" },
    ],
    answer: "B",
    explanation: "The doctor says 'the cure is simple: citrus fruit' — and explains they carry lime juice specifically for this.",
    hint: "The doctor gives the cure directly — listen for the simple answer that follows 'the cure is.'",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q10.mp3",
    audioScript: "Entry for the fourteenth. Weather: clear skies, calm seas, excellent visibility. Ships passed: eleven going north, four going south, two anchored offshore waiting for morning. I noticed that the third vessel heading north was flying a distress flag on its secondary mast — a small flag, easy to miss. I signaled them with the lighthouse lamp using three long pulses, the standard inquiry. They responded with two short pulses, meaning minor issue, no assistance needed. I logged it and moved on. The captain's name was painted on the bow — Esperanza. It passed safely by midnight.",
    question: "What did two short pulses mean in the lighthouse communication system?",
    choices: [
      { label: "A", text: "Major emergency, send help immediately" },
      { label: "B", text: "No ships are in the area" },
      { label: "C", text: "Minor issue, no assistance needed" },
      { label: "D", text: "Request permission to dock" },
    ],
    answer: "C",
    explanation: "The keeper explains that two short pulses meant 'minor issue, no assistance needed' — the standard response from the distressed vessel.",
    hint: "The keeper describes a signal exchange — listen for what the two-pulse response means.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q11.mp3",
    audioScript: "This is the first mate's evening report. All crew present and accounted for — twenty-three sailors, including myself. The night watch rotation begins at the eighth bell with four crew members on the upper deck. The cargo hold was inspected at noon — all ropes secure, no shifting. One issue: the portside railing near the stern has a loose bolt. I have placed a warning rope around it and assigned the ship's carpenter to fix it tomorrow morning. The captain has been informed. All other systems nominal. Weather forecast for tonight: light winds, no rain expected.",
    question: "What was done about the loose bolt on the portside railing?",
    choices: [
      { label: "A", text: "It was fixed immediately by the first mate" },
      { label: "B", text: "It was reported to the harbor authority" },
      { label: "C", text: "A warning rope was placed and a carpenter assigned for tomorrow" },
      { label: "D", text: "The railing was removed for safety" },
    ],
    answer: "C",
    explanation: "The first mate 'placed a warning rope around it and assigned the ship's carpenter to fix it tomorrow morning.'",
    hint: "Two actions were taken about the loose bolt — listen for both.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q12.mp3",
    audioScript: "Attention, fishing fleet! This is the coast guard vessel Malakas. We have received reports of a large school of yellowfin tuna approximately fourteen nautical miles northeast of your current position. The school is moving south at approximately three knots. If you depart within the next two hours, you should be able to intercept. However, be advised: the same area has reported strong afternoon currents starting around the fourth hour of the afternoon. Small vessels under fifteen meters should exercise caution. Larger vessels may proceed normally. This is a courtesy notification only — coast guard out.",
    question: "What warning applies specifically to small vessels under fifteen meters?",
    choices: [
      { label: "A", text: "They must stay in the harbor" },
      { label: "B", text: "They should exercise caution due to strong afternoon currents" },
      { label: "C", text: "They are forbidden from fishing in that area" },
      { label: "D", text: "They must travel in groups" },
    ],
    answer: "B",
    explanation: "The coast guard says 'small vessels under fifteen meters should exercise caution' due to the strong afternoon currents in that area.",
    hint: "The coast guard gives different advice for different vessel sizes — listen for what applies to the smaller ones.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q13.mp3",
    audioScript: "I am reading from the ship's cargo manifest. Hold one contains forty crates of ceramic tiles, each crate weighing thirty kilograms. Hold two contains twenty barrels of palm oil, each barrel weighing eighty kilograms. Hold three is empty — the original cargo of timber was offloaded at the last port. The total weight of cargo on board is currently two thousand eight hundred kilograms. The ship's maximum safe load is four thousand kilograms, meaning we have one thousand two hundred kilograms of remaining capacity. We are permitted to take on additional cargo at the next stop.",
    question: "Why is Hold Three currently empty?",
    choices: [
      { label: "A", text: "It was never loaded" },
      { label: "B", text: "The timber cargo was offloaded at the last port" },
      { label: "C", text: "The tiles were moved from Hold Three to Hold One" },
      { label: "D", text: "It is reserved for emergency supplies" },
    ],
    answer: "B",
    explanation: "The manifest says Hold Three is empty because 'the original cargo of timber was offloaded at the last port.'",
    hint: "The speaker explains why Hold Three is empty — listen for what happened to the original cargo.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q14.mp3",
    audioScript: "Every ship has its traditions and some sailors take them very seriously. On our vessel, there are three things we never do. We never whistle on deck — it is said to call the wind and invite storms. We never bring a banana on board — the reason is practical, not superstitious: the gas released by bananas can spoil other food and attract insects. And we never change the ship's name once it has been given — it is considered deeply unlucky. I am not personally superstitious, but I follow these rules to respect the crew's comfort and tradition.",
    question: "What is the PRACTICAL reason for the ban on bananas?",
    choices: [
      { label: "A", text: "Bananas are too heavy for small vessels" },
      { label: "B", text: "They are a sign of bad luck" },
      { label: "C", text: "The gas they release can spoil food and attract insects" },
      { label: "D", text: "The captain dislikes them personally" },
    ],
    answer: "C",
    explanation: "The speaker distinguishes the banana ban as 'practical, not superstitious' — the gas released by bananas spoils food and attracts insects.",
    hint: "Listen for when the speaker says one rule is practical rather than superstitious — that rule is about bananas.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q15.mp3",
    audioScript: "Attention night watch crew! Your shift begins now and ends at sunrise. Your primary duties are: scan the horizon every fifteen minutes for lights from other vessels, check the anchor chain every hour to ensure we have not drifted, and record any unusual sounds or sightings in the log. If you spot another vessel within one nautical mile, wake the first mate immediately — do not handle it alone. If you hear a distress signal, wake the entire senior crew. Never leave your post without a replacement. The sea can change in minutes. Stay alert.",
    question: "What should the night watch do if they spot a vessel within one nautical mile?",
    choices: [
      { label: "A", text: "Handle it alone" },
      { label: "B", text: "Record it in the log and continue" },
      { label: "C", text: "Wake the entire crew" },
      { label: "D", text: "Wake the first mate immediately" },
    ],
    answer: "D",
    explanation: "The briefing says if a vessel is within one nautical mile, 'wake the first mate immediately — do not handle it alone.'",
    hint: "The briefing gives different instructions for different situations — listen for the rule about close vessels specifically.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q16.mp3",
    audioScript: "I am the shipwright, and I just finished inspecting the hull after our last voyage. Here is what I found. The upper hull — no damage, paint is intact. The waterline area — minor barnacle growth on the starboard side, nothing urgent. Below the waterline — I found one significant crack near the bow on the port side, approximately thirty centimeters long. This must be repaired before the next voyage. The repair will take two days and will require the ship to be dry-docked. I have already submitted the repair order. The ship is not in immediate danger, but it cannot sail until this is fixed.",
    question: "Where did the shipwright find the significant crack?",
    choices: [
      { label: "A", text: "On the upper hull near the stern" },
      { label: "B", text: "On the starboard waterline area" },
      { label: "C", text: "Near the bow on the port side, below the waterline" },
      { label: "D", text: "In the cargo hold floor" },
    ],
    answer: "C",
    explanation: "The shipwright says the crack is 'near the bow on the port side' and is located below the waterline.",
    hint: "The inspector checks three areas — listen for which one had the serious problem and its exact location.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q17.mp3",
    audioScript: "I want to tell you about a rescue we performed last November. We were three days from port when we received a distress signal from a small fishing vessel. They had engine failure and were taking on water. We reached them in forty minutes. The fishing boat had five crew members, all wearing life vests. The boat itself was beyond saving — it sank thirty minutes after we arrived. We transferred all five crew members safely to our ship. The captain of the fishing vessel was the last to leave, as is tradition. She thanked us and said her crew's lives were worth more than the boat. She was right.",
    question: "Why did the fishing boat sink?",
    choices: [
      { label: "A", text: "It was struck by another vessel" },
      { label: "B", text: "It caught fire" },
      { label: "C", text: "Engine failure caused it to take on water" },
      { label: "D", text: "The crew abandoned it too early" },
    ],
    answer: "C",
    explanation: "The speaker says the fishing vessel had 'engine failure and was taking on water' — that is what led to it sinking.",
    hint: "Listen for the cause of the vessel's distress — two things are mentioned together.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q18.mp3",
    audioScript: "Welcome to rope maintenance. I am the rope master, and ropes are the most important equipment on this ship — more important than the engines in an emergency. There are three things you must check every week. First: look for fraying along the full length of the rope. Even a small fray can become a full break under load. Second: check for saltwater stiffness — if a rope cannot bend smoothly, it needs to be soaked in fresh water. Third: check the eyes and loops at the ends — these are the weakest points and the first to fail. A broken rope at the wrong moment costs lives.",
    question: "Why must sailors check the eyes and loops at the rope ends?",
    choices: [
      { label: "A", text: "They are the hardest to replace" },
      { label: "B", text: "They are the weakest points and first to fail" },
      { label: "C", text: "Saltwater stiffness starts there" },
      { label: "D", text: "Fraying begins at the ends" },
    ],
    answer: "B",
    explanation: "The rope master says 'the eyes and loops at the ends are the weakest points and the first to fail.'",
    hint: "The third check is about the ends of the rope — listen for why those spots matter most.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q19.mp3",
    audioScript: "Good morning. I am the ship's weather observer. My reading this morning at the sixth hour: barometric pressure is falling rapidly — a drop of eight millibars in the last four hours. This pattern typically indicates an incoming storm within twelve to eighteen hours. Wind has shifted from southwest to northwest overnight. Sky conditions: thickening clouds on the western horizon, consistent with storm approach. Sea swell is increasing from one meter to approximately two meters. My recommendation to the captain: alter course to the south to avoid the projected storm path. I will give an updated reading at noon.",
    question: "What does a rapidly falling barometric pressure typically indicate?",
    choices: [
      { label: "A", text: "Calm weather approaching" },
      { label: "B", text: "An incoming storm within 12–18 hours" },
      { label: "C", text: "A wind shift from northwest to southwest" },
      { label: "D", text: "Increasing visibility at sea" },
    ],
    answer: "B",
    explanation: "The observer says a rapid pressure drop 'typically indicates an incoming storm within twelve to eighteen hours.'",
    hint: "The observer explains what the pressure reading means — listen for the weather prediction.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q20.mp3",
    audioScript: "Good afternoon. I am harbor pilot Celeste, and I will be guiding your vessel into port. A harbor pilot's job is to take temporary command of the ship while navigating the harbor entrance and docking area. The captain remains on the bridge and can override my instructions at any time, but typically defers to my local knowledge. I have piloted vessels into this harbor over three thousand times. The main challenges here are the shallow sandbar at the eastern entrance — you cannot enter from the east — and the strong tidal current that runs through the main channel between the second and fourth bells. We will enter at the western gate during slack tide. Follow my instructions exactly.",
    question: "Why can vessels NOT enter from the eastern entrance?",
    choices: [
      { label: "A", text: "It is reserved for emergency vessels" },
      { label: "B", text: "A shallow sandbar blocks it" },
      { label: "C", text: "The tidal current is too strong there" },
      { label: "D", text: "The harbor pilot does not work on the eastern side" },
    ],
    answer: "B",
    explanation: "The pilot says 'the main challenge here is the shallow sandbar at the eastern entrance — you cannot enter from the east.'",
    hint: "The pilot describes two challenges in the harbor — listen for which one affects the eastern entrance specifically.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q21.mp3",
    audioScript: "I am the ship's chief engineer. The engine room is my responsibility. Here is what I need every crew member to know. The engine room is off-limits to anyone without authorization — one wrong action can disable the entire ship. There are two emergency shutdowns: the red lever on the left wall stops the main engine, the blue lever on the right wall cuts the fuel supply. The red lever is for immediate engine failure — use it if the engine makes a grinding noise or overheats. The blue lever is only for fire in the engine room. Using the wrong lever in the wrong situation can make things worse. Remember which color is which.",
    question: "When should the BLUE lever be used?",
    choices: [
      { label: "A", text: "When the engine overheats" },
      { label: "B", text: "When the engine makes a grinding noise" },
      { label: "C", text: "Only when there is a fire in the engine room" },
      { label: "D", text: "Whenever the main engine must be stopped" },
    ],
    answer: "C",
    explanation: "The engineer says the blue lever 'cuts the fuel supply' and is 'only for fire in the engine room.'",
    hint: "Two levers have two different purposes — listen for the specific situation where the blue one applies.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q22.mp3",
    audioScript: "I am going to teach you how to read a tide chart. A tide chart shows the rise and fall of sea level over time. The highest point on the chart is called high tide, and the lowest is low tide. The time between a high tide and the next low tide is approximately six hours. The difference between high and low tide is called the tidal range. On our chart for today, high tide occurs at the second hour of the morning and again at the second hour of the afternoon. Low tide occurs at the eighth hour of the morning and the eighth hour of the evening. The tidal range today is four meters.",
    question: "What is the tidal range?",
    choices: [
      { label: "A", text: "The time between two high tides" },
      { label: "B", text: "The highest point on the tide chart" },
      { label: "C", text: "The difference between high and low tide" },
      { label: "D", text: "Six hours of sea level change" },
    ],
    answer: "C",
    explanation: "The teacher defines tidal range as 'the difference between high and low tide.'",
    hint: "Several tide terms are defined — listen for the specific definition of 'tidal range.'",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q23.mp3",
    audioScript: "This is a record of the crew meeting held on the ninth day of the voyage. Three complaints were raised. First complaint: the sleeping quarters are too hot — three crew members asked for better ventilation. Second complaint: the rations have been reduced without explanation — five crew members signed this complaint. Third complaint: the carpenter has not repaired the broken bunk in Cabin Four — this has been reported three times already with no action. The captain addressed all three. Ventilation: fans will be installed next port. Rations: explained by bad weather delays — will return to normal in two days. Broken bunk: carpenter ordered to fix it today, before sunset.",
    question: "How many crew members signed the complaint about reduced rations?",
    choices: [
      { label: "A", text: "Three" },
      { label: "B", text: "Four" },
      { label: "C", text: "Five" },
    ...
    answer: "C",
    explanation: "The record says 'five crew members signed this complaint' about the unexplained ration reduction.",
    hint: "Numbers are given for each complaint — listen for the count specifically attached to the rations complaint.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q24.mp3",
    audioScript: "The captain called all officers to the map room. She had found something in the ship's archive — an old chart, dated over a century ago. On the chart, there was a route marked in red ink that was different from any known passage. The route appeared to cut through an area we usually avoid due to shallow water. The captain asked the navigator to compare the old chart with modern depth readings. The navigator's conclusion: the waterway shown on the old map is real but was only usable at high tide. At low tide, the channel becomes impassable. The captain decided to attempt the passage at tomorrow's high tide.",
    question: "Why is the old waterway usually avoided?",
    choices: [
      { label: "A", text: "It is too long compared to the standard route" },
      { label: "B", text: "It is haunted according to sailors' legends" },
      { label: "C", text: "It appears to go through shallow water" },
      { label: "D", text: "The old map was considered inaccurate" },
    ],
    answer: "C",
    explanation: "The captain found the route goes through 'an area we usually avoid due to shallow water.'",
    hint: "Listen for the captain's reason for usually avoiding that area — it's about the water conditions.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q25.mp3",
    audioScript: "On the morning of the third day, a stowaway was discovered hiding in the lower cargo hold between two crates of dried goods. She was a young woman, approximately eighteen years old. She said she had no money for a ticket but needed to reach the capital for a medical reason she would not explain. The captain had three options: put her to work in exchange for passage, turn back to drop her at the last port, or continue and hand her to the port authority at the destination. Turning back would cost one full day of sailing. The captain chose the first option — she was put to work in the galley.",
    question: "Why did the captain NOT choose to turn back?",
    choices: [
      { label: "A", text: "The captain felt sorry for the stowaway" },
      { label: "B", text: "Turning back would cost one full day of sailing" },
      { label: "C", text: "There was no last port to return to" },
      { label: "D", text: "The port authority requested it" },
    ],
    answer: "B",
    explanation: "The passage states that 'turning back would cost one full day of sailing' — this is the implied reason the captain avoided that option.",
    hint: "The captain had three options — listen for what was specifically mentioned as the cost of turning back.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q26.mp3",
    audioScript: "Signal flags are one of the oldest forms of communication at sea. Each flag represents a letter, a number, or a specific message. The flag for the letter Q — which is yellow — means 'my vessel is healthy and I request free passage.' The flag for the letter O — which is red and yellow diagonal — means 'man overboard.' The flag for the letter W — which is blue, white, and red — means 'I require medical assistance.' When you see a vessel flying the letter O flag, you must stop and assist immediately. No other duty takes priority over a man-overboard signal.",
    question: "What does the letter O flag signal mean?",
    choices: [
      { label: "A", text: "The vessel is healthy and requests free passage" },
      { label: "B", text: "Man overboard" },
      { label: "C", text: "Medical assistance required" },
      { label: "D", text: "Request for harbor entry" },
    ],
    answer: "B",
    explanation: "The teacher says the O flag (red and yellow diagonal) means 'man overboard' and requires immediate response.",
    hint: "Three flag meanings are given — listen for the one that requires the most urgent response.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q27.mp3",
    audioScript: "Storm incoming! All crew, begin the storm preparation checklist immediately. One: secure all loose items on deck — ropes, tools, equipment. Anything not tied down will become a projectile. Two: close and latch all hatches and portholes. Three: move all non-essential crew below deck. Essential deck crew: helmsman and two lookouts only. Four: reduce sail to storm sails. Do not use the main sail in high winds. Five: activate the bilge pump on automatic cycle. The captain estimates the storm will hit in approximately ninety minutes. All checklist items must be completed before the storm arrives. Report to the first mate when done.",
    question: "Who is allowed to remain on deck during the storm?",
    choices: [
      { label: "A", text: "All crew members" },
      { label: "B", text: "Non-essential crew only" },
      { label: "C", text: "The helmsman and two lookouts" },
      { label: "D", text: "The first mate and the captain" },
    ],
    answer: "C",
    explanation: "The checklist says 'essential deck crew: helmsman and two lookouts only' — all others must go below deck.",
    hint: "The checklist specifies exactly who stays on deck — listen for the number and titles of those crew members.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q28.mp3",
    audioScript: "My name is Andres, and I survived a shipwreck three years ago. Our ship hit an uncharted reef at night during a storm. The ship sank in less than twenty minutes. There were forty crew members. Twelve reached the lifeboats. The rest either drowned or were rescued from the water by a passing vessel that arrived six hours later. I was one of the twelve in the lifeboat. We drifted for two days before we were found. The hardest part was not the cold or the hunger — it was the uncertainty of not knowing if anyone was looking for us. They were. A search team found us on the morning of the third day.",
    question: "How long did Andres and the others drift in the lifeboat before being found?",
    choices: [
      { label: "A", text: "Six hours" },
      { label: "B", text: "One day" },
      { label: "C", text: "Two days" },
      { label: "D", text: "Three weeks" },
    ],
    answer: "C",
    explanation: "Andres says 'we drifted for two days before we were found' — they were found on the morning of the third day.",
    hint: "Several time periods are mentioned — listen for how long the lifeboat drifted specifically.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q29.mp3",
    audioScript: "When a ship is anchored overnight, anchor watch must be maintained. The anchor watch is one crew member who stays awake and monitors whether the ship is dragging anchor — that means the anchor is losing its grip and the ship is slowly moving. To check for dragging: take a bearing on two fixed points on shore. If those bearings change over fifteen minutes, the ship is dragging. If dragging is detected, wake the captain immediately. Do not attempt to re-anchor without the captain's order. Dragging anchor in a busy harbor can lead to collision with other vessels. One crew member lost their position last year for failing to report drag.",
    question: "How can the anchor watch tell if the ship is dragging anchor?",
    choices: [
      { label: "A", text: "The engine room alarm sounds" },
      { label: "B", text: "The ship tilts to one side" },
      { label: "C", text: "The bearings on shore landmarks change over time" },
      { label: "D", text: "The anchor chain makes a scraping noise" },
    ],
    answer: "C",
    explanation: "The protocol says to 'take a bearing on two fixed points on shore — if those bearings change over fifteen minutes, the ship is dragging.'",
    hint: "A specific method is described for detecting drag — listen for what the crew member observes on shore.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q30.mp3",
    audioScript: "There was a disagreement at the docks today between the cargo supervisor and the ship's captain. The supervisor wanted to load an additional twenty crates of machine parts on top of the agreed manifest. The captain refused, saying the ship was already at ninety percent of its load limit and adding twenty more crates would exceed safe capacity. The supervisor argued the crates were light — only fifteen kilograms each, a total of three hundred kilograms. The captain said the total weight was not the issue — the distribution of weight would shift the ship's balance. The supervisor backed down. The crates were left on the dock.",
    question: "Why did the captain refuse the additional crates?",
    choices: [
      { label: "A", text: "They were not listed on the original manifest" },
      { label: "B", text: "The crates were too heavy to lift safely" },
      { label: "C", text: "Adding them would shift the ship's balance, not just exceed weight" },
      { label: "D", text: "The captain had already agreed with a different supplier" },
    ],
    answer: "C",
    explanation: "The captain's concern was not total weight but that 'the distribution of weight would shift the ship's balance.'",
    hint: "The supervisor thought weight was the issue, but the captain gave a different reason — listen for what the captain said the real problem was.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q31.mp3",
    audioScript: "My name is Captain Leny, and I lead a night fishing crew. Night fishing is different from day fishing in three important ways. First, navigation relies entirely on instruments — there are no visual landmarks in the dark, so your GPS and compass must be trusted completely. Second, fish behave differently at night — many species come closer to the surface in darkness, which means we use different net depths. Third, safety is harder to maintain — equipment is harder to see, and the risk of a crew member falling overboard is higher. We use tether ropes on every crew member after midnight. No exceptions.",
    question: "Why do the fish come closer to the surface at night?",
    choices: [
      { label: "A", text: "The water is warmer near the surface" },
      { label: "B", text: "Many species naturally rise to the surface in darkness" },
      { label: "C", text: "The nets force them upward" },
      { label: "D", text: "The boat lights attract them upward" },
    ],
    answer: "B",
    explanation: "Captain Leny says 'many species come closer to the surface in darkness' — this is a natural behavior difference.",
    hint: "The captain explains how fish behave differently at night — listen for the natural reason they move toward the surface.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q32.mp3",
    audioScript: "A compass rose is the diagram printed on charts and compasses that shows directions. The four main directions are north, south, east, and west — these are called cardinal directions. Between them are four intercardinal directions: northeast, southeast, southwest, and northwest. For more precise navigation, each of these is further divided into north-northeast, east-northeast, and so on — creating sixteen total directions. When a captain says 'sail fifteen degrees off north,' they mean a direction that is almost north but slightly to the right, toward the northeast. Understanding direction precisely is how ships avoid collisions in open water.",
    question: "What are the four main directions called?",
    choices: [
      { label: "A", text: "Primary directions" },
      { label: "B", text: "Intercardinal directions" },
      { label: "C", text: "Cardinal directions" },
      { label: "D", text: "Compass bearings" },
    ],
    answer: "C",
    explanation: "The speaker says north, south, east, and west 'are called cardinal directions.'",
    hint: "The speaker gives a specific name to the four main directions — listen for that term.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q33.mp3",
    audioScript: "A distress flare is a signal device used at sea to call for rescue. There are three types. Red flares are the most recognized distress signal — they mean 'I am in danger, I need help now.' Orange smoke flares are used during daytime when visibility is low — the smoke can be seen from a distance even when a red flare might not be noticed. White flares are warning flares — they signal presence to avoid collision but do not mean distress. If you ever find a flare on a ship, do not fire it unless you are in a genuine emergency. A false distress signal can send rescue teams in the wrong direction and put real emergencies at risk.",
    question: "When should orange smoke flares be used instead of red flares?",
    choices: [
      { label: "A", text: "At nighttime in stormy conditions" },
      { label: "B", text: "When the vessel is sinking slowly" },
      { label: "C", text: "During daytime when visibility is low" },
      { label: "D", text: "When white flares are unavailable" },
    ],
    answer: "C",
    explanation: "The speaker says orange smoke flares 'are used during daytime when visibility is low — the smoke can be seen from a distance.'",
    hint: "Each flare type has a specific use — listen for the condition that makes the orange smoke type most effective.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q34.mp3",
    audioScript: "Ship's log, day twenty-two. Position: southern edge of the open sea, bearing southwest. Weather: overcast skies, wind from the north at twelve knots, sea state moderate. Event of note: at the fourteenth hour, we sighted a sea turtle tangled in what appeared to be a fishing net. The crew voted unanimously to stop and assist. It took forty-five minutes to free the turtle. The first mate expressed concern about the delay to our schedule. The captain overruled and said the delay was acceptable. The turtle was released unharmed. We resumed course. We are now approximately six hours behind schedule. The crew's mood is noticeably good.",
    question: "How did the crew vote on whether to help the sea turtle?",
    choices: [
      { label: "A", text: "The captain decided alone without a vote" },
      { label: "B", text: "The vote was split evenly" },
      { label: "C", text: "The first mate overruled the crew" },
      { label: "D", text: "The crew voted unanimously to stop and assist" },
    ],
    answer: "D",
    explanation: "The log says 'the crew voted unanimously to stop and assist' the sea turtle.",
    hint: "Listen for how the vote on helping the turtle turned out — the key word describes the result clearly.",
  },
  {
    audioUrl: "https://assets.linguaquest.app/audio/mp-q35.mp3",
    audioScript: "After thirty-eight days at sea, we arrived at the final port this morning. The crew gathered on the deck as we entered the harbor. No one spoke. The journey had cost us two sails, one damaged anchor, fourteen days of bad weather, and one crew member who had to be left behind at a port midway due to illness — she was recovering well, according to the last message we received. The cargo was intact. The ship was intact. Everyone who finished the voyage was safe. The captain looked at the crew and said simply: We made it. The harbor bells rang as we docked. Several crew members wept. Nobody thought that was strange.",
    question: "Why was one crew member left behind at a port during the voyage?",
    choices: [
      { label: "A", text: "They refused to continue" },
      { label: "B", text: "They were needed at the port for work" },
      { label: "C", text: "Due to illness — they were left to recover" },
      { label: "D", text: "They chose to stay permanently" },
    ],
    answer: "C",
    explanation: "The log says one crew member 'had to be left behind at a port midway due to illness' and was recovering well.",
    hint: "Listen for the reason given for leaving the crew member behind — it was involuntary.",
  },
];
